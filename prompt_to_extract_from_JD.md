...
1. Identify core technical skills and any specific tools or technologies mentioned.  
2. Note all explicitly required certifications or licenses (e.g., PMP, AWS Certifications).  
3. Prioritize mandatory requirements—focus on the most crucial skills, minimum experience, and language proficiencies.  
4. If the role specifies a certain seniority (e.g., Senior Developer, Mid-level Manager) or a specific functional area (e.g., UI/UX, Data Engineering), incorporate these into the prompt.  
